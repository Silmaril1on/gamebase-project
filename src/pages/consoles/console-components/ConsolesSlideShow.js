      ...
      <section className="relative h-500 overflow-hidden">
        <AnimatePresence initial={false} custom={direction}>
          <motion.div
            ...
            custom={direction}
            className="absolute h-full w-full flexRow"
          >
            ...
            <article className="pl-5 pt-10 w-2/4 bg-white text-black flexCol justify-between">
              <div className="flexCol">
                <h1 className="text-3xl capitalize font-bold mb-3">
                  {consoles[index].name}
                </h1>
                <p className="text-blue-400 pr-5">{consoles[index].desc}</p>
                <h1 className="text-6xl mt-5 font-light">
                  {consoles[index].info}
                </h1>
              </div>
              <div className="relative z-5 mb-10 space-x-5">
